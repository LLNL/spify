...
template std::vector<bool>  parser::get<std::vector<bool> >(const std::string& key);
...
template void parser::get<std::vector<bool> >(const std::string& key, std::vector<bool> & val);
